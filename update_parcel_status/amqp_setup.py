...
queue_name = 'nodemailer-amqp' 
channel.queue_declare(queue=queue_name, durable=True) 
routing_key = '*.email' # parcelFail.email
channel.queue_bind(exchange=exchangename, queue=queue_name, routing_key=routing_key)   # any routing_key with two words and ending with '.email' will be matched
